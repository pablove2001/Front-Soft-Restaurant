  ...
  return (
    <a href={link}>
      <div className="max-w-xs rounded overflow-hidden shadow-lg m-4 flex flex-col justify-center items-center">
        <img
          className="w-40 h-40 object-cover m-4"
          src={imageUrl}
          alt={title}
        />
        ...
        <div>
            ...
            <div className="flex flex-wrap justify-center">
                <div className="flex justify-center items-center h-screen">
                    <AdminCard title="Empleados" imageUrl="/empleados.png" link="/admin/employees" />
                    <AdminCard title="Productos" imageUrl="/hamburguesa.png" link="/admin/products" />
                    <AdminCard title="Categorías" imageUrl="/categorias.png" link="/admin/categories" />
                    <AdminCard title="Mesas" imageUrl="/comedor.png" link="/admin/tables" />
                </div>
            </div>
        </div>
    );
